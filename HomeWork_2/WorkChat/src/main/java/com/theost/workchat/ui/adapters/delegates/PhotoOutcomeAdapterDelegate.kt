...
import com.theost.workchat.databinding.ItemPhotoOutcomeBinding
import com.theost.workchat.network.api.ApiConfig
import com.theost.workchat.ui.interfaces.AdapterDelegate
import com.theost.workchat.ui.interfaces.DelegateItem
import okhttp3.Credentials

class PhotoOutcomeAdapterDelegate : AdapterDelegate {
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        val binding = ItemPhotoOutcomeBinding.inflate(
    ...
    override fun isOfViewType(item: DelegateItem): Boolean =
        item is ListPhoto && item.messageType == MessageType.OUTCOME

    class ViewHolder(private val binding: ItemPhotoOutcomeBinding) :
